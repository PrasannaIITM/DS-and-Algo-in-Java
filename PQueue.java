...
public class PQueue <T extends Comparable<T>>{
    private int heapSize = 0;//number of elements currently inside heap
    private int heapCapacity = 0;//internal capacity of the heap
    ...
    private void sink(int k){
        while(true){
            ...
            //stop if outside the bounds or cannot sink k anymore
    ...
    private void mapAdd(T value, int index){
        ...
        if(set == null){
            ...
            set.add(index);
            map.put(value, set);
        }else set.add(index);//value already exists in map
