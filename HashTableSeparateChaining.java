...
//methods for handling collisions: separate chaining insertions(linked list at each location)
...
public class HashTableSeparateChaining <K,V> implements Iterable <K> {
    ...
    //converts hash value to index between [0, capacity)
    //& 0x7FFFFFFF strips negative sign
